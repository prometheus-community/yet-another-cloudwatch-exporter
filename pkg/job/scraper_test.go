				...
				return []*model.CloudwatchData{
					{
						...
						GetMetricDataResult: &model.GetMetricDataResult{Statistic: "Maximum", Datapoints: model.SingleDataPoint(aws.Float64(1.0), time.Time{})},
					},
				}, nil
			},
			expectedResources: []model.TaggedResourceResult{
				...
				return []*model.CloudwatchData{
					{
						...
						GetMetricDataResult: &model.GetMetricDataResult{Statistic: "Minimum", Datapoints: model.SingleDataPoint(aws.Float64(2.0), time.Time{})},
					},
				}, nil
			},
			expectedMetrics: []model.CloudwatchMetricResult{
